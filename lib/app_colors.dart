...
final Color tabvar= Color(0xFFfdfdfd);
final Color starcolor = Color(0xFFfdc746);
final Color subtiteltext = Color(0xFFc5c4ca);
final Color  lovecolor= Color(0xFF00ace6);
final Color audiobluebackgroundcolor = Color(0xFFeeeffa);
final Color audiogrybackgroundcolor  = Color(0xFFf2f2f2);
